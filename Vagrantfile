...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "./", "/usr/src/hello/"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    apt-get update
    # apt-get install -y git gcc g++ cmake libcurl4-openssl-dev zlib1g zlib1g-dev libssl-dev zip
    apt-get install -y git gcc g++ cmake libcurl4-openssl-dev libssl-dev uuid-dev zlib1g-dev libpulse-dev zip
